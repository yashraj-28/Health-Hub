...
import { databases, DATABASE_ID, ENDPOINT, BUCKET_ID, PROJECT_ID, APPOINTMENT_COLLECTION_ID, messaging } from "../appwrite.config";
    ...
    try {
        ...
        `
            ...
            ${ type === 'schedule' ? 
             ...
             `We regret to inform you that your appoinment has been cancelled. Reason: ${appointment.cancellationReason}`}
        `
